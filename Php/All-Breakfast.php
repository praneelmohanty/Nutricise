...
$sqlVeg = "SELECT food_link, food FROM `All-Breakfast` WHERE food_preference='vegetarian'";
$sqlNonVeg = "SELECT food_link, food FROM `All-Breakfast` WHERE food_preference='non-vegetarian'";
